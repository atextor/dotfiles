...
(custom-set-faces
 ...
 '(tabbar-selected-modified ((t (:inherit tabbar-default :background "#263238" :foreground "yellow" :box nil :height 120 :width normal :family "Source Code Pro"))))
 ...
 '(tabbar-unselected-modified ((t (:inherit tabbar-unselected :background "#1c1f26" :foreground "DarkOrange3" :box nil :height 120 :width normal :family "Source Code Pro")))))
